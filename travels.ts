import { CreateUtazasiIrodaDto } from "src/utazasi-iroda/dto/create-utazasi-iroda.dto";
import { UpdateUtazasiIrodaDto } from "src/utazasi-iroda/dto/update-utazasi-iroda.dto";
import { UtazasiIroda } from "src/utazasi-iroda/entities/utazasi-iroda.entity";



export class Travels {
  #travels: UtazasiIroda[] = [];
  #nextId = 1;
  #addDiscount = 0;
   ...
   */
  add(data: CreateUtazasiIrodaDto) {
   ...
   */
  replace(id: number, data: UpdateUtazasiIrodaDto) {
